This pipeline extract the text and images from pdf and docx file and put then into markdown(md) file of mkdocs in arranged order.This way we can see our contents of pdf and docx in mkdocs website.
